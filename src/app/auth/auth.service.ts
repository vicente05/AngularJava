...
export class AuthService {
    ...
    public login(usuario: Usuario): Observable<any> {
        ...
        const urlEndpoint = environment.apiRest + "/oauth/token";
        const credenciales = btoa(environment.credencialesApi.username + ':' + environment.credencialesApi.password);
    ...
    public guardarToken(accesToken: string): void {
